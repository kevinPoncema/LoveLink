...
<template>
    <div class="min-h-screen bg-stone-50 dark:bg-stone-900">
        ...
        <main class="max-w-7xl mx-auto px-6 py-8">
            ...
            <!-- Empty State -->
            <div v-else class="text-center py-20 bg-white dark:bg-stone-800 rounded-2xl border border-stone-200 dark:border-stone-700">
                ...
                <Link
                    href="/landings/create"
                    class="inline-block bg-rose-600 hover:bg-rose-700 text-white px-6 py-3 rounded-xl font-medium transition-colors shadow-md hover:shadow-lg"
                >
                    Comenzar ahora
                </Link>
            </div>
